<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jw600.aspx.cs" Inherits="pages_aircraft_jw600" %>
...
<body>
    ...
    <div class="container" id="top-center">
        <div class="col-lg-12" style="height: auto;">
            <div>
                <img style="max-width: 100%" src="/images/commercial/marquee-767.jpg" />
            </div>
        </div>
    </div>   
